...
`npm install`, and wait for all the required dependencies to be installed.

After, yo can run:

`npm start`, for runs the app in the development mode. And after you can open [http://localhost:3000](http://localhost:3000) to view it in your browser. The page will reload when you make changes, you may also see any lint errors in the console.
